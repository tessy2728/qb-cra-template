...
const getErrorMessage = payload => {
  if (!payload.statusCode) return payload.message;
  switch (payload.statusCode) {
    case 401:
      return 'You are not authorized to view the page.';
    case 500:
    default:
      return 'Oops, Something Went Wrong!';
  }
};
export const signIn = createAsyncThunk('user/signIn', async (postParams, thunkAPI) => {
  try {
